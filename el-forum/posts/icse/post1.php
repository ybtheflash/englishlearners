...
<body>
    ...
    <div class="container my-2" id="ques">
        <?php
        $sql = "SELECT * FROM `icse` WHERE id = 1";
        ...
        <form action= "' . $_SERVER['REQUEST_URI'] . '" method="post"> 
            ...
            if ($method == 'POST') {
                ...
                $sql2 = "INSERT INTO `icse_comments` (`comment_content`, `post_id`, `comment_by`, `comment_time`) VALUES ('$comment_content','1','$s_id', current_timestamp());";
