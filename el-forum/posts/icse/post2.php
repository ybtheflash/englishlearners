...
<body>
    ...
    <div class="container my-2" id="ques">
        <?php
        $sql = "SELECT * FROM `icse` WHERE id = 2";
        ...
        <form action= "' . $_SERVER['REQUEST_URI'] . '" method="post"> 
            ...
            if ($method == 'POST') {
                ...
                $sql2 = "INSERT INTO `icse_comments` (`comment_content`, `post_id`, `comment_by`, `comment_time`) VALUES ('$comment_content','2','$s_id', current_timestamp());";
            ...
            <?php
            $sql2 = "SELECT * FROM `icse_comments` WHERE post_id=$id";
            $result = mysqli_query($conn2, $sql2);
            $noResult = true;
            while ($row = mysqli_fetch_assoc($result)) {
                $noResult = false;
