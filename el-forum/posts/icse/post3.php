...
<body>
    ...
    <div class="container my-2" id="ques">
        <?php
        $sql = "SELECT * FROM `icse` WHERE id = 3";
        ...
        <form action= "' . $_SERVER['REQUEST_URI'] . '" method="post"> 
            ...
            if ($method == 'POST') {
                ...
                $sql2 = "INSERT INTO `icse_comments` (`comment_content`, `post_id`, `comment_by`, `comment_time`) VALUES ('$comment_content','3','$s_id', current_timestamp());";
