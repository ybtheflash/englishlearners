...
<body>
    ...
    <div class="container my-2" id="ques">
        <?php
        $sql = "SELECT * FROM `cbse` WHERE id = 1";
        ...
        <form action= "' . $_SERVER['REQUEST_URI'] . '" method="post"> 
            ...
            if ($method == 'POST') {
                ...
                $sql2 = "INSERT INTO `cbse_comments` (`comment_content`, `post_id`, `comment_by`, `comment_time`) VALUES ('$comment_content','1','$s_id', current_timestamp());";
            ...
            <?php
            $sql2 = "SELECT * FROM `cbse_comments` WHERE post_id=$id";
            $result = mysqli_query($conn2, $sql2);
            $noResult = true;
            while ($row = mysqli_fetch_assoc($result)) {
                $noResult = false;
